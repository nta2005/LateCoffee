...
import com.nta.latecoffee.adapter.MyFoodListAdapter;
...
public class FoodListFragment extends Fragment {
    ...
    @BindView(R.id.refreshFood)
    SwipeRefreshLayout refreshFood;
    LayoutAnimationController layoutAnimationController;
    MyFoodListAdapter adapter;
    private FoodListListViewModel foodlistViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        foodlistViewModel = new ViewModelProvider(this).get(FoodListListViewModel.class);
    ...
    private void reloadFood() {
        refreshFood.setOnRefreshListener(() -> {
